...
<head>
	...
	function inputIdInfoOnClick() {
		...
		if(txtidObj.value == ''){
			enterGuideIdObj.innerHTML = "영문과 숫자를  혼합하여 4~12자 사이로 사용할 수 있습니다. "
	...
	function handleOptionChange(selectElement) {
        ...
        var text = selectElement.option[selectElement.selectedIndex].text;
        
        document.querySelector('div').innerHTML 
        	= 'text: ${selectElement} value: ${value}';
    }
		...
		<div class="info-cont">
			<ul>
				...
				<li class="enteremail_area">
					...
					<select name="emailSelAdd" id="email_Domain" 
